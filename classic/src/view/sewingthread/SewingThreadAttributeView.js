Ext.define('GSmartApp.view.sewingtrim.SewingThreadAttributeView', {
    extend: 'Ext.grid.Panel',
    xtype: 'SewingThreadAttributeView',
    id:'SewingThreadAttributeView',
    controller: 'SewingThreadAttributeViewController',
    IdProduct: 0,
    viewConfig: {
        stripeRows: true,
