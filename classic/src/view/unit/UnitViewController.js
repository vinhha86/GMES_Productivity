Ext.define('GSmartApp.view.unit.UnitViewController', {
    ...
    onThemMoi: function (m, record) {
        ...
        this.redirectTo("unit/create");
    },
    onCapNhatdbl: function (m, record, item, index, e, eOpts) {
        var id = record.data.id;
        this.redirectTo("unit/" + id + "/edit");
    ...
    onXoa: function (grid, rowIndex, colIndex) {
        ...
        Ext.Msg.show({
            title: 'Thông báo',
            msg: 'Bạn có chắc chắn xóa unit "' + name + '" ?',
    ...
    Xoa: function (id, rec) {
        ...
        GSmartApp.Ajax.post('/api/v1/unit/deleteUnit', Ext.JSON.encode(params),
