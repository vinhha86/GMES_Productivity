Ext.define('GSmartApp.view.deviceinvcheck.InvCheckDeviceDetailListController', {
	extend: 'Ext.app.ViewController',
	alias: 'controller.InvCheckDeviceDetailListController',
		...
		var form = Ext.create('Ext.window.Window', {
            ...
            items: [{
                ...
                viewModel: {
                    ...
                    data: {
						deviceid_link: record.data.id,
						// deviceinid_link: record.data.deviceinid_link,
						isInvCheckDeviceDetailList: true
                    }
                }
            }]
		});
