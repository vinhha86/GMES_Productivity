Ext.define('GSmartApp.view.stockin.StockInList', {
    extend: 'Ext.Panel',
	xtype:'stockinlist',
    controller: 'stockinlist',
	viewModel: {
        type: 'stockoutlist'
    },
	layout: {
	...
	items:[{
		 ...
		 items:[{
			 ...
			 name:'stockcode',
			 xtype: 'combobox',
			 emptyText:GSmartApp.Locales.donvi_caphang[GSmartApp.Locales.currentLocale],
			 store:'OrgStore',
			 queryMode: 'local',
			 displayField: 'name',
			 valueField: 'id'
		...
		{ 
			text: GSmartApp.Locales.donvi_caphang[GSmartApp.Locales.currentLocale],
