Ext.define('GSmartApp.view.porder_gantt.Porder_gantt_guess_Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.Porder_gantt_guess_Controller',
    isActivate: false,
    init: function () {
    ...
    onExportGantt: function(){
        var me = this.getView().down('#Gantt_GuessKeHoach');
    ...
    onZoomInGantt: function () {
        ...
        this.getView().down('#Gantt_GuessKeHoach').zoomIn();
    },

    onZoomOutGantt: function () {
        console.log(this.getView())
        this.getView().down('#Gantt_GuessKeHoach').zoomOut();
        // this.getView().zoomOut(1,viewmodel.get('gantt.startDate'),viewmodel.get('gantt.endDate'));
    },

    onSearch: function() {
        var viewmodel = this.getViewModel();
        var store = this.getView().down('#Gantt_GuessKeHoach').getTaskStore();
        this.getView().down('#Gantt_GuessKeHoach').setStartDate(viewmodel.get('gantt.startDate'));
        this.getView().down('#Gantt_GuessKeHoach').setEndDate(viewmodel.get('gantt.endDate'));
        store.loadStore(viewmodel.get('gantt.startDate'), viewmodel.get('gantt.endDate'), viewmodel.get('gantt.listid'));
    },
    onPrint: function () {
        this.getView().down('#Gantt_GuessKeHoach').print();
    },
