Ext.define('GSmartApp.view.DashBoardView.LineChartPackStockedAmountController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.LineChartPackStockedAmountController',
    init: function () {
        var viewModel = this.getViewModel();
        var LineChartPackStockedAmountStore = viewModel.getStore('LineChartPackStockedAmountStore');
        LineChartPackStockedAmountStore.loadStore();
    },
