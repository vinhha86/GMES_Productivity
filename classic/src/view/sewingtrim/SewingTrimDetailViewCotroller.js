Ext.define('GSmartApp.view.sewingtrim.SewingTrimDetailViewCotroller', {
    ...
    onQuayLai: function () {
        this.redirectTo('lssewingtrim');
    },
    onLoadData: function (id, type) {
        this.IdProduct = id;

        viewInfo = Ext.getCmp('SewingTrimInfoView');
        viewInfo.IdProduct = id;
        viewInfo.getController().loadInfo(id);

        viewAttribute = Ext.getCmp('SewingTrimAttributeView');
        viewAttribute.IdProduct = id;

        imgView = Ext.getCmp('SewingTrimImageView');
