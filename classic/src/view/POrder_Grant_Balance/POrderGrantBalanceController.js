Ext.define('GSmartApp.view.POrder_Grant_Balance.POrderGrantBalanceController', {
    ...
    onBeforePersonnelGroupDrop:function(node, data, overModel, dropPosition, dropHandlers, eOpts){
        ...
        me.updatePorderGrantBalancePersonel(personnelid_link, porderbalanceid_link, pordergrantid_link);
    },
    updatePorderGrantBalancePersonel: function(personnelid_link, porderbalanceid_link, pordergrantid_link){
        var me = this;
        var viewModel = this.getViewModel();
