Ext.define('GSmartApp.view.salary.Salary_Sum_Porders_ListOrg_Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.Salary_Sum_Porders_ListOrg_Controller',
    init: function () {
        this.onload();
    },
    control: {
        '#Salary_Sum_Porders_ListOrg': {
