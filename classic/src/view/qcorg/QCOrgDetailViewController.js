Ext.define('GSmartApp.view.qcorg.QCOrgDetailViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.QCOrgDetailViewController',
    Id: 0,
    init: function () {
        var me = this.getView();
    ...
    onLuu: function (thisBtn) {
        ...
        data.id = this.Id;
        data.orgtypeid_link = 16;
        data.status = 1;

        params.data = data;
        params.msgtype = "QCORG_CREATE";
        params.message = "Tạo đơn vị QC";
                ...
                if (success) {
                    ...
                    if (response.respcode == 200) {
                        ...
                        if(thisBtn.itemId=='btnLuuVaTaoMoi')
                            me.Id = 0;
                        m.redirectTo("lsqcorg/" + me.Id + "/edit");
                    }
                    else {
                        Ext.Msg.show({
                            title: 'Lưu thất bại',
