Ext.define('GSmartApp.view.mainfactory.MainFactoryDetailViewCotroller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.MainFactoryDetailViewCotroller',
    Id: 0,
    init: function () {
        var me = this.getView();
    },
    ...
    onLuu: function () {
        var viewMain = Ext.getCmp('MainFactoryView');
