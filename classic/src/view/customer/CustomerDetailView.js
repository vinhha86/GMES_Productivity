Ext.define('GSmartApp.view.Customer.CustomerDetailView', {
    extend: 'Ext.form.Panel',
    xtype: 'CustomerDetailView',
    id:'CustomerDetailView',
    controller: 'CustomerDetailViewCotroller',
    viewModel:{
    ...
    items: [{
        ...
        xtype:'textfield',
        margin: 5,
        fieldLabel: 'Khách hàng ('+ '<span style="color:red">*</span>' + ')',
        allowBlank: false,
        blankText : 'Không được để trống',
        bind:{
