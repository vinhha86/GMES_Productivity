Ext.define('GSmartApp.view.Customer.CustomerDetailViewCotroller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.CustomerDetailViewCotroller',
    Id: 0,
    init: function () {
        var me = this.getView();
    },
    ...
    onLuu: function () {
        var viewMain = Ext.getCmp('CustomerView');
