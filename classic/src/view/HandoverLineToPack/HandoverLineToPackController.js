Ext.define('GSmartApp.view.handoverlinetopack.HandoverLineToPackController', {
    ...
    onThemMoi: function (m, record) {
        ...
        this.redirectTo("handover_line_topack/" + 0 + "/edit");
    },
    onCapNhatdbl: function (m, record, item, index, e, eOpts) {
        var id = record.data.id;
        this.redirectTo("handover_line_topack/" + id + "/edit");
    },
