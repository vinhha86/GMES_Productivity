Ext.define('GSmartApp.view.handoverlinetopack.HandoverLineToPackSKUDetailController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.HandoverLineToPackSKUDetailController',
    init: function () {
        ...
        GSmartApp.Ajax.post('/api/v1/handoversku/updateHandoverSku', Ext.JSON.encode(params),
            function (success, response, options) {
                ...
                if (success) {
                    ...
                    var main = Ext.getCmp('handover_line_topack_edit');
