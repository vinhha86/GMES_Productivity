Ext.define('GSmartApp.view.handoverlinetopack.HandoverLineToPackSKUDetail', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverLineToPackSKUDetail',
    id: 'HandoverLineToPackSKUDetail',
    reference: 'HandoverLineToPackSKUDetail',
    controller: 'HandoverLineToPackSKUDetailController',
    viewModel:{
