Ext.define('GSmartApp.view.handoverlinetopack.HandoverLineToPackConfirmController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.HandoverLineToPackConfirmController',
    isActivate: false,
    init: function () {
    },
    control: {
            ...
            function (success, response, options) {
                if (success) {
                    ...
                    if (response.respcode == 200) {
                        ...
                        //
                        var mainView;
                        if(viewModel.get('isOut')) mainView = Ext.getCmp('handover_line_topack_edit');
                        if(viewModel.get('isIn')) mainView = Ext.getCmp('handover_pack_fromline_edit');
