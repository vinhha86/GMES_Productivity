Ext.define('GSmartApp.view.handoverlinetopack.HandoverLineToPackDetail_Info', {
    extend: 'Ext.form.Panel',
    xtype: 'HandoverLineToPackDetail_Info',
    id: 'HandoverLineToPackDetail_Info',
    // controller: 'POrder_InfoViewController',
    reference: 'HandoverLineToPackDetail_Info',
    bodyPadding: 5,
    border: false,
    IdPOrder: 0,
    items: [{
