Ext.define('GSmartApp.view.porders.POrder_Grant_Plan.POrder_Grant_Plan_Material_View', {
    extend: 'Ext.grid.Panel',
    xtype: 'POrder_Grant_Plan_Material_View',
    itemId: 'POrder_Grant_Plan_Material_View',
    reference: 'POrder_Grant_Plan_Material_View',
    controller: 'POrder_Grant_Plan_Material_View_Controller',
    viewConfig: {
        stripeRows: false,
        columnLines: true,
        rowLines: true
