Ext.define('GSmartApp.view.stockout.Stockout_packinglist_lotnumber_Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.Stockout_packinglist_lotnumber_Controller',
    init: function () {
    },
    control: {
      '#lotnumber': {
    ...
    //   },
      ...
      '#Stockout_packinglist_lotnumber': {
        select: 'onSelectlot'
      }
    },
