Ext.define('GSmartApp.view.stockout.Stockout_P_Poline_MainView', {
    extend: 'Ext.grid.Panel',
    xtype: 'Stockout_P_Poline_MainView',
    itemId: 'Stockout_P_Poline_MainView',
    // layout: 'border',
    controller: 'Stockout_P_Poline_MainViewController',
    viewModel: {
        type: 'Stockout_P_Poline_MainViewModel'
    },
    viewConfig: {
        stripeRows: false,
