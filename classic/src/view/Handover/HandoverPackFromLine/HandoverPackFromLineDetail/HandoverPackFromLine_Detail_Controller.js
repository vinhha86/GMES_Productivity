Ext.define('GSmartApp.view.handover.HandoverPackFromLine_Detail_Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.HandoverPackFromLine_Detail_Controller',
    init: function () {
        ...
        if(Ext.getCmp('handover_pack_fromline_detail')){
            m.getView().setTitle('Nhập thành phẩm vào tổ hoàn thiện');
            ...
            if(session.orgid_link == 1){
                ...
                ListOrgStore_To.getbyParentandType(session.orgid_link, orgtypestring_to);
            }
        }
    ...
    control: {
        ...
        '#HandoverPackFromLine_Detail_ProductGrid': {
    ...
    CancelConfirm: function(id){
        ...
        var mainView = Ext.getCmp('handover_pack_fromline_detail');
    ...
    onBtnSearch: function(){
        ...
        form.down('#HandoverPackFromLine_Detail_PorderSearch').getController().on('found0Porder', function () {
            Ext.Msg.show({
                title: "Thông báo",
        ...
        form.down('#HandoverPackFromLine_Detail_PorderSearch').getController().on('found1Porder', function (record) {
            Ext.Msg.show({
                title: "Thông báo",
                msg: "Tìm thấy 1 lệnh",
                buttons: Ext.MessageBox.YES,
        ...
        form.down('#HandoverPackFromLine_Detail_PorderSearch').getController().on('foundManyPorder', function (select) {
            if(select.length == 0){
                Ext.Msg.show({
                    title: "Thông báo",
                        ...
                        HandoverProductStore.load({
                            ...
                            callback: function(records, operation, success) {
                                if(!success){
                                    ...
                                    var HandoverDetail_ProductGrid = Ext.getCmp('HandoverPackFromLine_Detail_ProductGrid');
                ...
                if(!success){
                    ...
                    function (success, response, options) {
                        ...
                        if (success) {
                            ...
                            if(Ext.getCmp('HandoverPackFromLine_Detail_ProductGrid')){
                                Ext.getCmp('HandoverPackFromLine_Detail_ProductGrid').getSelectionModel().select(0, true);
                            }
                        }
                    }); 
                }
    ...
    onEditSkuTotalPackage: function (editor, context, e) { console.log(context);
        var HandoverDetail_ProductGrid = Ext.getCmp('HandoverPackFromLine_Detail_ProductGrid');
        var HandoverDetail_SkuGrid = Ext.getCmp('HandoverPackFromLine_Detail_SkuGrid');
    ...
    onConfirm: function(){
        ...
        var form = Ext.create('Ext.window.Window', {
            ...
            items: [{
                xtype: 'HandoverPackFromLine_Detail_Confirm',
                viewModel: {
                    type: 'HandoverPackFromLine_Detail_ConfirmViewModel',
                    data: {
        ...
        form.down('#HandoverPackFromLine_Detail_Confirm').getController().on('updateStatus', function (obj) {
            me.updateStatus(obj);
            form.close();
        });
    },
