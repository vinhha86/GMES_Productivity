Ext.define('GSmartApp.view.handover.HandoverPackFromLine_List', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverPackFromLine_List',
    id: 'HandoverPackFromLine_List',
    viewModel: {
        type: 'HandoverPackFromLine_ListViewModel'
    },
    controller: 'HandoverPackFromLine_ListController',
    reference: 'HandoverPackFromLine_List',
    viewConfig: {
        stripeRows: false,
        columnLines: true,
        rowLines: true
