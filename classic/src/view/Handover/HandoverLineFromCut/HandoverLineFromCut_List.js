Ext.define('GSmartApp.view.handover.HandoverLineFromCut_List', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverLineFromCut_List',
    id: 'HandoverLineFromCut_List',
    viewModel: {
        type: 'HandoverLineFromCut_ListViewModel'
    },
    controller: 'HandoverLineFromCut_ListController',
    reference: 'HandoverLineFromCut_List',
    viewConfig: {
        stripeRows: false,
        columnLines: true,
        rowLines: true
