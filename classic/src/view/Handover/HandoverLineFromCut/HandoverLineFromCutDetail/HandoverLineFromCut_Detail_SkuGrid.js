Ext.define('GSmartApp.view.handover.HandoverLineFromCut_Detail_SkuGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverLineFromCut_Detail_SkuGrid',
    id: 'HandoverLineFromCut_Detail_SkuGrid',
    reference: 'HandoverLineFromCut_Detail_SkuGrid',
    viewConfig: {
        stripeRows: true,
        columnLines: true,
        rowLines: true
