Ext.define('GSmartApp.view.handover.HandoverLineToPrint_Detail_Confirm', {
    extend: 'Ext.form.Panel',
    xtype: 'HandoverLineToPrint_Detail_Confirm',
    id:'HandoverLineToPrint_Detail_Confirm',
    controller: 'HandoverLineToPrint_Detail_ConfirmController',
    // viewModel: {
