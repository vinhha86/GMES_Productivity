Ext.define('GSmartApp.view.handover.HandoverLineToPrint_List', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverLineToPrint_List',
    id: 'HandoverLineToPrint_List',
    viewModel: {
        type: 'HandoverLineToPrint_ListViewModel'
    },
    controller: 'HandoverLineToPrint_ListController',
    reference: 'HandoverLineToPrint_List',
    viewConfig: {
        stripeRows: false,
        columnLines: true,
        rowLines: true
