Ext.define('GSmartApp.view.handover.HandoverPackToStock_Detail_SkuGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverPackToStock_Detail_SkuGrid',
    id: 'HandoverPackToStock_Detail_SkuGrid',
    reference: 'HandoverPackToStock_Detail_SkuGrid',
    viewConfig: {
        stripeRows: true,
        columnLines: true,
        rowLines: true
