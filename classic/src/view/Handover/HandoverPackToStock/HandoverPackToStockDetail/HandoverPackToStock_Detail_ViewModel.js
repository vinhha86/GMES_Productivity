Ext.define('GSmartApp.view.handover.HandoverPackToStock_Detail_ViewModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.HandoverPackToStock_Detail_ViewModel',
    requires: [
    ...
    data: {
        ...
        viewId: '', // id view HandoverDetail ex: handover_pack_tostock_detail
        viewIdParent: '', // id view parent HandoverDetail ex: handover_pack_tostock_edit
        viewIdList: '', //  id view list, for btnQuayLai ex: handover_pack_tostock
        radioVal: 2,
