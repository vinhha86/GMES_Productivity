Ext.define('GSmartApp.view.handover.Handover_kho_tocut_packinglist_lotnumber_Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.Handover_kho_tocut_packinglist_lotnumber_Controller',
    init: function () {
    },
    control: {
      '#lotnumber': {
    ...
    //   },
      ...
      '#Handover_kho_tocut_packinglist_lotnumber': {
        select: 'onSelectlot'
      }
    },
    ...
    //   viewModel.set('packinglist.sizenumber', sizenumber);
      ...
      for(var i=0; i < pklist.length; i++){
        if(pklist[i].lotnumber == lotnumber){
