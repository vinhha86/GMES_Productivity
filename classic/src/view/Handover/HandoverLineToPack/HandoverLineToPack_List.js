Ext.define('GSmartApp.view.handover.HandoverLineToPack_List', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverLineToPack_List',
    id: 'HandoverLineToPack_List',
    viewModel: {
        type: 'HandoverLineToPack_ListViewModel'
    },
    controller: 'HandoverLineToPack_ListController',
    reference: 'HandoverLineToPack_List',
    viewConfig: {
        stripeRows: false,
        columnLines: true,
        rowLines: true
