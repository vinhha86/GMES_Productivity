Ext.define('GSmartApp.view.handover.HandoverCutToline_Detail_Confirm', {
    extend: 'Ext.form.Panel',
    xtype: 'HandoverCutToline_Detail_Confirm',
    id:'HandoverCutToline_Detail_Confirm',
    controller: 'HandoverCutToline_Detail_ConfirmController',
    // viewModel: {
