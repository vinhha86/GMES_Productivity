Ext.define('GSmartApp.view.handover.HandoverCutToline_List', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverCutToline_List',
    id: 'HandoverCutToline_List',
    viewModel: {
        type: 'HandoverCutToline_ListViewModel'
    },
    controller: 'HandoverCutToline_ListController',
    reference: 'HandoverCutToline_List',
    viewConfig: {
        stripeRows: false,
        columnLines: true,
        rowLines: true
