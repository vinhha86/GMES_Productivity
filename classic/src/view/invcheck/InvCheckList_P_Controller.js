Ext.define('GSmartApp.view.invcheck.InvCheckList_P_Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.InvCheckList_P_Controller',
	init: function() {
	...
	onCreate:function(){
		...
		this.redirectTo("invcheck_product/create");
	},
	onSearch:function(){
	...
	onItemdblclick: function(grid, record, index, e, eOpts ){
		...
		this.redirectTo("invcheck_product/"+id+"/edit");
	},
