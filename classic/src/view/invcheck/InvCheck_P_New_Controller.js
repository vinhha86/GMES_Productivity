Ext.define('GSmartApp.view.invcheck.InvCheck_P_New_Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.InvCheck_P_New_Controller',
	packinglist:null,
    init: function() {
	...
	onUrlBack:function(){
		this.redirectTo("invcheck_product");
	},
	onBlack:function(){
			...
			function(success,response,options ) {
				if(success){
					...
					//	me.getById(response.data[0].id);
						me.redirectTo("invcheck_product/"+response.data[0].id+"/edit");
					}
				}
