Ext.define('GSmartApp.view.handovercuttoprint.HandoverCutToPrintSKUDetail', {
    extend: 'Ext.grid.Panel',
    xtype: 'HandoverCutToPrintSKUDetail',
    id: 'HandoverCutToPrintSKUDetail',
    reference: 'HandoverCutToPrintSKUDetail',
    controller: 'HandoverCutToPrintSKUDetailController',
    viewModel:{
