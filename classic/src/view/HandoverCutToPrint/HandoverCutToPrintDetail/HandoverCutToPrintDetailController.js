Ext.define('GSmartApp.view.handovercuttoprint.HandoverCutToPrintDetailController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.HandoverCutToPrintDetailController',
    init: function () {
        ...
        var ListOrgStore_Print = viewModel.getStore('ListOrgStore_Print');
        var orgtypestring2 = '20';
        ListOrgStore_Print.loadStoreByOrgTypeString(orgtypestring2);
    ...
    onBtnSearch: function(){
        ...
        var form = Ext.create('Ext.window.Window', {
            ...
            items: [{
                xtype: 'HandoverCutToPrintPorderSearch',
                viewModel: {
                    type: 'HandoverCutToPrintPorderSearchViewModel',
                    data: {
    ...
    onLuu: function (thisBtn) {
        ...
        if(viewModel.get('currentRec.porderid_link') == null){
            Ext.Msg.show({
                title: 'Thông báo',
                msg: 'Cần chọn lệnh sản xuất',
                buttons: Ext.MessageBox.YES,
                buttonText: {
                    yes: 'Đóng',
                }
            ...
            function (success, response, options) {
                ...
                if (success) {
                    if (response.respcode == 200) {
                        ...
                        m.redirectTo("handover_cut_toprint/" + response.data.id + "/edit");
            ...
            items: [
            {
                ...
                handler: function(){
                    ...
                    var form = Ext.create('Ext.window.Window', {
                        ...
                        items: [{
                            xtype: 'HandoverCutToPrintSKUDetail',
                            viewModel: {
                                type: 'HandoverCutToPrintSKUDetailViewModel',
                                data: {
    ...
    onConfirm: function(btn){
        ...
        if(btn.itemId == 'btnHandover') isOut = true;
        if(btn.itemId == 'btnConfirm') isIn = true;
        ...
        var form = Ext.create('Ext.window.Window', {
            ...
            items: [{
                xtype: 'HandoverCutToPrintConfirm',
                viewModel: {
                    type: 'HandoverCutToPrintConfirmViewModel',
                    data: {
                        handoverid_link: handoverid_link,
                        isIn: isIn,
                        isOut: isOut
