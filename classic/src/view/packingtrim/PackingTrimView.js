Ext.define('GSmartApp.view.packingtrim.PackingTrimView', {
    extend: 'Ext.grid.Panel',
    xtype: 'PackingTrimView',
    id: 'PackingTrimView',
    viewModel: {
        type: 'PackingTrimViewModel'
    },
    controller: 'PackingTrimViewCotroller',
    reference: 'PackingTrimView',
    viewConfig: {
        stripeRows: true,
        columnLines: true,
        rowLines: true
