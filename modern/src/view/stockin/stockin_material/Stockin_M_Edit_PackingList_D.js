    ...
    itemTpl:
            '<div class="content">' +
                '<div class="content1">' +
                    ...
                    '<div class="unitid_link1{unitid_link}">Met nhập: {met_origin}</div>' +
                    '<div class="unitid_link3{unitid_link}">YDS nhập: {ydsorigin}</div>' +
                    '<div>Mã vạch:</div>' +
                '</div>' +
                '<div class="content1">' +
                    '<div>Số Cây/Bó/Túi: <b>{packageid}</b></div>' +
                    '<div>Khổ kiểm: {width_check}</div>' +
                    '<div class="unitid_link1{unitid_link}">Met kiểm: {met_check}</div>' +
                    '<div class="unitid_link3{unitid_link}">YDS kiểm: {ydscheck}</div>' +
                    '<div>Mã chip:</div>' +
                '</div>' +
            '</div>',
