Ext.define('GSmartApp.view.stockin.Stockin_M_List', {
    ...
    itemTpl:
            '<div class="content">' +
                '<div class="content1">' +
                '<div class="content1-sub1"><b>Số phiếu:</b> <b>{stockincode}</b></div>' +
                // '<div class="content1-sub2"><b>Ngày nhập:</b> {stockindate}</div>' +
                '<div class="content1-sub2"><b>Ngày nhập:</b> {stockindate:date("m/d/Y")}</div>' +
                '</div>' +
                '<div class="content1">' +
                ...
                '</div>' +
                '<div class="content2"><b>Loại nhập:</b> {stockintype_name}</div>' +
